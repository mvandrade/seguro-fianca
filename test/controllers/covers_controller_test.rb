...
class CoversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post covers_url, params: { cover: { branch_id: @cover.branch_id, description: @cover.description, name: @cover.name } }
    end
  ...
  test "should update cover" do
    patch cover_url(@cover), params: { cover: { branch_id: @cover.branch_id, description: @cover.description, name: @cover.name } }
